...
class Order(models.Model):
    ...
    member_discount = models.DecimalField(max_digits=6, decimal_places=2,
                                          null=False, default=0)
    ...
    def update_total(self):
        ...
        if self.order_total > 100:
            ...
            self.delivery_cost = self.order_total * (
                settings.DELIVERY_CHARGE / 100)

        self.member_discount = self.order_total * (
...
class OrderLineItem(models.Model):
    ...
    def __str__(self):
        return f'{self.ticket.friendly_name} on\
